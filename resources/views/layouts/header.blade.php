...
{{--                                    <li>--}}
{{--                                        <div class="timeline-panel">--}}
{{--                                            <div class="media mr-2 media-info">گ.ز--}}
{{--                                            </div>--}}
{{--                                            <div class="media-body">--}}
...
{{--                                </ul>--}}
{{--                            </div>--}}
{{--                            <a class="all-notification" href="#">مشاهده همه اعلان ها <i--}}
{{--                                    class="ti-arrow-right"></i></a>--}}
{{--                        </div>--}}
{{--                    </li>--}}
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{ !is_null(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset("assets/images/profile/pic1.jpg") }}" width="20" alt=""/>
                            <div class="header-info">
                                <span>سلام, <strong> {{ Auth::user()->name }}  </strong></span>
