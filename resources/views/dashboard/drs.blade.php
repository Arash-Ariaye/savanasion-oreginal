        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">مدیریت دامپزشک ها</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display min-w800">
                            <thead>
                            <tr>
                                        ...
                                        <div class="dropdown ml-auto text-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item"
                                                   href="{{ route('edit-dr', $item->id) }}">ویرایش</a>
                                                <form action="{{ route('destroy-dr', $item->id) }}" method="post">
                                                    @csrf
                                                    @method("DELETE")
